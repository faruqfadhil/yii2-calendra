    ...
    <div class="container pb30">
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12 product">
                ...
                <h1 class="product-name">Donasi Rutin</h1>
                ...
                >
                    <table>
                        ...
                        <tr>
                            ...
                            <td><font color="#e74c3c"><?= $poin ?></font></td>
                        </tr>
                        </tbody>
                    </table>
                </ul>
                <form id="donasi">
                    <div class="product-color-filter-container">
                        ...
                        <center>Terima kasih, Anda telah memilih Donasi Rutin Bulanan</center>
                        <br/>
                        <center>
                            <div style="background-color: #f1c40f; height: 80px; width: 250px">
                                Jumlah yang harus dibayar
                                <br>
                                <?= "<strong>" . 'Rp ' . \app\components\Angka::toReadableAngka($model->jumlah_donasi, FALSE) . "</strong>"; ?>
                            </div>
                        </center>
                        <br>
                        <br>
                        1. Transfer sejumlah
                        <strong><?= 'Rp ' . \app\components\Angka::toReadableAngka($model->jumlah_donasi, FALSE) ?></strong>
                        ke salah satu nomor rekening Alumni ITS di bawah ini :
                        <br>
