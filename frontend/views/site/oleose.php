        ...
        <div class="tp-banner" >
            <ul>
                ...
                <li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
                    <!-- MAIN IMAGE -->
                    <img src="<?= Yii::$app->request->baseUrl.'/themes/Oleose/assets/img/transparent.png' ?>"  alt="slidebg1"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                    <!-- LAYERS -->
                    <!-- LAYER NR. 1 -->
                    <div class="tp-caption lfl fadeout hidden-xs"
                        ...
                        <img src="<?= Yii::$app->request->baseUrl.'/themes/Oleose/assets/img/freeze/Slides/hand-freeze.png' ?>" alt="">
                    </div>
                    ...
                    <div class="tp-caption lfl fadeout visible-xs"
                         ...
                         data-start="700"
                         data-easing="Power4.easeOut">
                        <img src="<?= Yii::$app->request->baseUrl.'/themes/Oleose/assets/img/freeze/iphone-freeze.png' ?>" alt="">
                    </div>
                ...
                <li data-transition="zoomout" data-slotamount="7" data-masterspeed="1000" >
                    ...
                    <div class="tp-caption lfb fadeout hidden-xs"
                         ...
                         data-start="700"
                         data-easing="Power4.easeOut">
                        <img src="<?= Yii::$app->request->baseUrl.'/themes/Oleose/assets/img/freeze/Slides/freeze-slide2.png' ?>" alt="">
                    </div>
                ...
                <li data-transition="zoomout" data-slotamount="7" data-masterspeed="1000" >
                    ...
                    <div class="tp-caption customin customout hidden-xs"
                         ...
                         data-start="700"
                         data-easing="Power4.easeOut">
                        <img src="<?= Yii::$app->request->baseUrl.'/themes/Oleose/assets/img/freeze/Slides/family-freeze.png' ?>" alt="">
                    </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-4" >
                    <img src="<?= Yii::$app->request->baseUrl.'/themes/Oleose/assets/img/freeze/iphone-freeze.png' ?>" class="img-responsive scrollpoint sp-effect5" alt="">
                </div>
    ...
    <section id="screens">
        <div class="container">
            ...
            <div class="slider filtering scrollpoint sp-effect5" >
                <div class="one">
                    <img src="<?= Yii::$app->request->baseUrl.'/themes/Oleose/assets/img/freeze/screens/profile.jpg' ?>" alt="">
                    <h4>Profile Page</h4>
                </div>
                <div class="two">
                    <img src="<?= Yii::$app->request->baseUrl.'/themes/Oleose/assets/img/freeze/screens/menu.jpg' ?>" alt="">
                    <h4>Toggel Menu</h4>
                </div>
                <div class="three">
                    <img src="<?= Yii::$app->request->baseUrl.'/themes/Oleose/assets/img/freeze/screens/weather.jpg' ?>" alt="">
                    <h4>Weather Forcast</h4>
                </div>
                <div class="one">
                    <img src="<?= Yii::$app->request->baseUrl.'/themes/Oleose/assets/img/freeze/screens/signup.jpg' ?>" alt="">
                    <h4>Sign Up</h4>
                </div>
                <div class="one">
                    <img src="<?= Yii::$app->request->baseUrl.'/themes/Oleose/assets/img/freeze/screens/calendar.jpg' ?>" alt="">
                    <h4>Event Calendar</h4>
                </div>
                <div class="two">
                    <img src="<?= Yii::$app->request->baseUrl.'/themes/Oleose/assets/img/freeze/screens/options.jpg' ?>" alt="">
                    <h4>Some Options</h4>
                </div>
                <div class="three">
                    <img src="<?= Yii::$app->request->baseUrl.'/themes/Oleose/assets/img/freeze/screens/sales.jpg' ?>" alt="">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="hanging-phone scrollpoint sp-effect2 hidden-xs">
                        <img src="<?= Yii::$app->request->baseUrl.'/themes/Oleose/assets/img/freeze/freeze-angled2.png' ?>" alt="">
                    </div>
                    <div class="platforms">
