...
?>
<div class="subheader subheader-v2 has-bg-image" data-bg-image="img/blog-header.jpg">
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <h1 class="block-title">Blog</h1>
                <p class="block-secondary-title invert">Our daily musings  </p>
            </div>
        </div>
    </div>
</div>

<div class="blog-content pt60 has-bg-image" data-bg-color="f4f4f4">
    <div class="container">
        <div class="row">
            <div class="col-md-9">
                <article class="uou-block-7f">
                    <img src="<?= Yii::$app->request->baseUrl ?>/img/blog-image-1.jpg" alt="" class="thumb">
                    ...
                    <h1><a href="single-blog.html">Perspiciatis Sint Pariatur Velit Corrupti</a></h1>
                    ...
                    <a href="single-blog.html" class="btn btn-small btn-primary">Read More</a>
                </article> <!-- end .uou-block-7f -->


                <article class="uou-block-7f">
                    <img src="<?= Yii::$app->request->baseUrl ?>/img/blog-image-2.jpg" alt="" class="thumb">
                ...
                <article class="uou-block-7f">
                    <img src="<?= Yii::$app->request->baseUrl ?>/img/blog-image-3.jpg" alt="" class="thumb">
                ...
                <article class="uou-block-7f">
                    <img src="<?= Yii::$app->request->baseUrl ?>/img/blog-image-4.jpg" alt="" class="thumb">
                ...
                <article class="uou-block-7f">
                    <img src="<?= Yii::$app->request->baseUrl ?>/img/blog-image-5.jpg" alt="" class="thumb">
                ...
                <div class="uou-sidebar">
                    ...
                    <div class="latest-post-widget">
                        <div class="post-single">
                            <img src="<?= Yii::$app->request->baseUrl ?>/img/p-post-1.png" alt="">
                        ...
                        <div class="post-single">
                            <img src="<?= Yii::$app->request->baseUrl ?>/img/p-post-2.png" alt="">
                            <p class="meta">January 12, 2015</p>
                            <p class="meta">Design</p>
                            <h6 class="post-title"><a href="#">Pariatur Vellit Corrupti Goes Into 2 Lines</a></h6>
                        ...
                        <div class="post-single">
                            <img src="<?= Yii::$app->request->baseUrl ?>/img/p-post-3.png" alt="">
                            <p class="meta">January 12, 2015</p>
                            <p class="meta">Design</p>
                            <h6 class="post-title"><a href="#">Pariatur Vellit Corrupti Goes Into 2 Lines</a></h6>
