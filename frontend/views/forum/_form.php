            ...
            <div class="post">
                <div class="topwrap">
                    ...
                    <div class="posttext pull-left">
                        ...
                        <div>
                            <?= $form->field($model, 'id_kategori_forum')->widget(\kartik\select2\Select2::classname(), [
                                'data' => \yii\helpers\ArrayHelper::map(\backend\models\KategoriForum::find()->all(), 'id', 'nama_kategori'),
                                'language' => 'de',
                ...
                <div class="content-restaurant" style="padding: 0">
                    <div class="sidebar" style="background-color: transparent">
                        <div class="sidebar-fields" style="padding-top: 5px">
                            ...
                            <div class="custom-select-box">
                                <?php
                                $arr6 = \frontend\models\Mahasiswa::find()->all();
                                $prd6 = \yii\helpers\ArrayHelper::map($arr6, 'kota', 'kota');
                                echo \kartik\widgets\Select2::widget([
                                    'name' => 'kota',
                                    'data' => $prd6,
                                    'size' => \kartik\widgets\Select2::MEDIUM,
