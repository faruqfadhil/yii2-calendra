 ...
 */	 
	...
	{
		return ['xxx'=>'yyy - V2']; // prepare and return a data provider for the "index" action
	...
	public function findSampleView($id)
	{
		...
		return ['aaa'=>'bbb -V2', 'the_id'=>$id]; // prepare and return a data provider for the "index" action
	}
